...
export const ITEMS = [
  ...
  { id: 'stoneAxe',   slot: 'weapon', level: 5, icon: '🪓', name: 'Stone Axe',     cost: { wood: 12, stone: 10 },
    weapon: { kind: 'melee', style: 'axe', dmg: 76, cd: 1.72, range: 1.8, chop: 2, mine: 0, tier: 1,
  ...
  { id: 'steelAxe',   slot: 'weapon', level: 12, icon: '⚒️', name: 'Iron Axe',      cost: { wood: 18, iron: 6 }, needs: 'furnace',
    weapon: { kind: 'melee', style: 'axe', dmg: 136, cd: 1.8, range: 1.9, chop: 3, mine: 0, tier: 2,
  ...
  { id: 'warAxe',     slot: 'weapon', level: 16, icon: '🔥', name: 'War Axe',       cost: { wood: 25, iron: 16, hide: 6 }, needs: 'furnace',
    weapon: { kind: 'melee', style: 'axe', dmg: 240, cd: 1.92, range: 2.0, chop: 4, mine: 0, tier: 3,
  ...
  { id: 'frostAxe', slot: 'weapon', level: 46, icon: '🧚', name: 'Frostforged Axe',
    ...
    weapon: { kind: 'melee', style: 'axe', dmg: 520, cd: 1.64, range: 2.35, chop: 6, mine: 1, tier: 4,
