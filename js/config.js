...
export const CLASS_TREES = [
  ...
  { id: 'beastmaster', icon: '🏹', name: 'Beastmaster', color: '#9bc56b',
    ...
    passives: [
      ...
      P('beast_pack_tactics', '🐆', 'Fleet Hunter', 22, 'Years afield quicken your step — you move faster to keep the perfect firing distance.', { speed: [0.3, 0.6, 1.0] }),
      ...
      P('beast_handler', '🦅', 'Deadeye', 44, 'An unerring eye for the vital spot: a big boost to ranged critical chance.', { rangedCrit: [0.06, 0.12, 0.18] }),
    ],
    actives: [
      ...
      A('beast_mend_pet', '🌿', 'Field Dressing', 29, 'Bind your wounds on the move, healing steadily over several seconds.', 'hot',
        { cd: 26, duration: [8, 11, 14], amount: [10, 15, 22] }),
      A('beast_hunt_command', '🐆', 'Cheetah\'s Pace', 33, 'Bound away with a burst of speed to open distance and keep kiting.', 'buff',
        { cd: 22, buff: 'sprint', duration: [4, 6, 8], power: [5, 7, 9] }),
      ...
      A('beast_stampede', '🏹', 'Arrow Storm', 50, 'Loose an unrelenting 12 s storm of arrows over a huge area — nowhere to hide (bow).', 'zone',
        { cd: 70, zone: 'arrows', castRange: 22, radius: [7, 8.5, 10], duration: 12, weaponMult: [0.45, 0.55, 0.65], interval: 0.9 }),
  ...
  { id: 'rogue', icon: '🗡️', name: 'Rogue', color: '#8ec6c9',
    ...
    actives: [
      ...
      A('rogue_fan_knives', '🗡️', 'Fan of Knives', 24, 'Hit every nearby enemy with poisoned knives.', 'aoe',
        { cd: 16, radius: [5, 6, 7], weaponMult: [1.4, 2.0, 2.6], poison: [6, 11, 16] }),
  ...
  { id: 'mage', icon: '🧙', name: 'Mage', color: '#9c9cff',
    ...
    actives: [
      ...
      A('mage_frost_nova', '🧊', 'Frost Nova', 20, 'Freeze all enemies around you.', 'magicAoe',
        { cd: 24, element: 'frost', radius: [5, 6, 7], damage: [25, 42, 62], stun: [2.0, 2.5, 3.0] }),
