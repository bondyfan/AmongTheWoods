...
export const ITEMS = [
  ...
  { id: 'steelAxe',   slot: 'weapon', level: 12, icon: '⚒️', name: 'Iron Axe',      cost: { wood: 18, iron: 6 }, 
  ...
  { id: 'warAxe',     slot: 'weapon', level: 16, icon: '🔥', name: 'War Axe',       cost: { wood: 25, iron: 16, hide: 6 }, 
  ...
  { id: 'ironPick',   slot: 'weapon', level: 12, icon: '⚒️', name: 'Iron Pickaxe',  cost: { wood: 15, iron: 8 }, 
  ...
  { id: 'obsidianPick', slot: 'weapon', level: 18, icon: '⛏️', name: 'Obsidian Pickaxe', cost: { iron: 18, stone: 30, essence: 6 }, 
  ...
  { id: 'recurveBow', slot: 'weapon', level: 14, icon: '🏹', name: 'Recurve Bow',   cost: { wood: 45, hide: 10, iron: 6 }, 
  ...
  { id: 'rapidBow',   slot: 'weapon', level: 16, icon: '🌀', name: 'Windstorm Bow', cost: { wood: 45, iron: 14, hide: 10 }, 
  ...
  { id: 'steelSword', slot: 'weapon', level: 18, icon: '⚔️', name: 'Knight\'s Sword', cost: { iron: 25, wood: 10, hide: 8 }, 
  ...
  { id: 'crossbow',   slot: 'weapon', level: 18, icon: '🎯', name: 'Crossbow',       cost: { wood: 50, iron: 20 }, 
  ...
  { id: 'highlandSpear', slot: 'weapon', level: 27, icon: '⚡', name: 'Highland Greatspear',
    cost: { wood: 55, iron: 38, hide: 18, essence: 14 }, 
  ...
  { id: 'serpentBow', slot: 'weapon', level: 41, icon: '🐍', name: 'Serpent Bow',
    cost: { wood: 85, hide: 35, iron: 45, essence: 35 }, 
  ...
  { id: 'frostAxe', slot: 'weapon', level: 46, icon: '🧚', name: 'Frostforged Axe',
    cost: { wood: 90, iron: 70, hide: 30, essence: 55 }, 
  ...
  { id: 'ironShield', slot: 'offhand', level: 14, icon: '🛡️', name: 'Iron Shield', cost: { iron: 14, wood: 12, hide: 5 }, 
    shield: { block: 0.72 }, desc: 'Hold Ctrl to block 72% incoming damage. Replaces your torch.' },
  // -- head (crafted from hides at the tent) --
  { id: 'leatherCap', slot: 'head', level: 5, icon: '🧢', name: 'Hide Cap',      cost: { hide: 4, meat: 10 }, stats: { hp: 25 },
    desc: '+25 max health.' },
  { id: 'boneHelm',   slot: 'head', level: 10, icon: '🦴', name: 'Bone Helm',     cost: { hide: 6, meat: 20 }, stats: { hp: 45, regen: 0.2 },
    desc: '+45 max health, +0.2 ❤️/s regeneration.' },
  { id: 'furHood',    slot: 'head', level: 12, icon: '🎩', name: 'Fur Hood',      cost: { hide: 10, meat: 25 }, stats: { hp: 60, regen: 0.3 },
    desc: '+60 max health, +0.3 ❤️/s regeneration.' },
  { id: 'ironHelm',   slot: 'head', level: 14, icon: '🪖', name: 'Iron Helm',     cost: { iron: 10, hide: 6 }, stats: { hp: 85 },
    desc: '+85 max health.' },
  { id: 'bearHelm',   slot: 'head', level: 18, icon: '⛑️', name: 'Bearskull Helm', cost: { hide: 18, iron: 8, meat: 40 }, stats: { hp: 110, regen: 0.6 },
    desc: '+110 max health, +0.6 ❤️/s regeneration.' },
  // -- chest (you start NAKED with a leaf — clothing is crafted from hides) --
  { id: 'leatherArmor', slot: 'chest', level: 5, icon: '🦺', name: 'Hide Tunic',     cost: { hide: 7, meat: 15 }, stats: { hp: 50 },
    desc: '+50 max health. Finally, actual clothes.' },
  { id: 'furCoat',      slot: 'chest', level: 12, icon: '🧥', name: 'Fur Coat',       cost: { hide: 14, meat: 30 }, stats: { hp: 100, regen: 0.4 },
    desc: '+100 max health, +0.4 ❤️/s regeneration.' },
  { id: 'ironChest',    slot: 'chest', level: 14, icon: '🥋', name: 'Iron Cuirass',   cost: { iron: 14, hide: 8 }, stats: { hp: 135 },
    desc: '+135 max health.' },
  { id: 'bearHide',     slot: 'chest', level: 18, icon: '🛡️', name: 'Bearhide Plate', cost: { hide: 24, iron: 12, meat: 45 }, stats: { hp: 170, regen: 0.8 },
    desc: '+170 max health, +0.8 ❤️/s regeneration.' },
  { id: 'graveplate', slot: 'chest', level: 35, icon: '⚰️', name: 'Graveplate',
    cost: { iron: 55, hide: 30, essence: 32 }, stats: { hp: 275, regen: 1.1 },
    desc: 'Spirit-bound plate from the haunted woods. +275 max health, +1.1 ❤️/s.' },
  { id: 'iceplate', slot: 'chest', level: 48, icon: '🧊', name: 'Iceplate',
    cost: { iron: 90, hide: 45, essence: 70 }, stats: { hp: 390, regen: 1.5 },
    desc: 'Armor built for the summit. +390 max health, +1.5 ❤️/s.' },
  // -- boots --
  { id: 'swiftBoots',   slot: 'boots', level: 5, icon: '👢', name: 'Hide Wraps',     cost: { hide: 5, meat: 10 }, stats: { speed: 1.5 },
    desc: '+1.5 movement speed.' },
  { id: 'huntersBoots', slot: 'boots', level: 12, icon: '🥾', name: "Hunter's Boots", cost: { hide: 10, meat: 25 }, stats: { speed: 2.5 },
    desc: '+2.5 movement speed.' },
  { id: 'ironBoots',    slot: 'boots', level: 14, icon: '🥾', name: 'Iron-Shod Boots', cost: { iron: 8, hide: 6 }, stats: { speed: 3, hp: 35 },
    desc: '+3 movement speed, +35 max health.' },
  { id: 'windBoots',    slot: 'boots', level: 18, icon: '💨', name: 'Windwalkers',    cost: { hide: 14, iron: 8, meat: 40 }, stats: { speed: 4.5, regen: 0.5 },
    desc: '+4.5 movement speed, +0.5 ❤️/s regeneration.' },
  { id: 'pantherBoots', slot: 'boots', level: 39, icon: '🐆', name: 'Pantherstep Boots',
    cost: { hide: 45, iron: 25, essence: 30 }, stats: { speed: 6, hp: 90, regen: 0.8 },
  ...
  { id: 'wolfPendant', slot: 'charm', level: 10, icon: '🦷', name: 'Wolf-Fang Pendant',
    cost: { hide: 8, meat: 30 }, stats: { dmgPct: 0.10 },
    desc: '+10% weapon damage.' },
  { id: 'hawkAmulet', slot: 'charm', level: 14, icon: '🪶', name: 'Hawk-Feather Amulet',
    cost: { hide: 12, iron: 4, meat: 40 }, stats: { aspd: 0.10, regen: 0.3 },
  ...
  { id: 'bloodAmulet', slot: 'charm', level: 18, icon: '🩸', name: 'Bloodstone Amulet',
    cost: { hide: 15, iron: 10, essence: 10 }, stats: { regen: 1.2, hp: 40 },
  ...
  { id: 'spiritLantern', slot: 'offhand', level: 33, supply: true, icon: '🏮', name: 'Spirit Lantern',
    cost: { iron: 25, essence: 28 }, torch: { radius: 20, permanent: true }, stats: { regen: 0.5 },
  ...
  { id: 'bogscaleLining', slot: 'underlayer', level: 22, supply: true, icon: '🐊', name: 'Bogscale Lining',
    cost: { hide: 25, wool: 20, essence: 12 }, dmgCut: 0.12, poisonCut: 0.5,
  ...
  { id: 'stormcloak', slot: 'back', level: 29, supply: true, icon: '🌩️', name: 'Stormcloak',
    cost: { hide: 30, wool: 28, iron: 15, essence: 20 }, stats: { hp: 120, regen: 0.8 }, rest: 5,
  ...
  // ======================================================================
  // ---- CRIT GEAR: the first equipment that moves crit at all ----
  // Crit chance and crit damage became real, gear-movable stats, so here is
  // the gear that moves them. Bought like any other kit.
  // ======================================================================
  { id: 'keenBand', slot: 'charm', level: 8, icon: '💍', name: 'Keen Band',
    cost: { iron: 6, hide: 4 }, stats: { crit: 0.04 },
    desc: '+4% critical chance. A hunter\'s first real luxury.' },
  { id: 'whetstoneCharm', slot: 'charm', level: 16, icon: '🪨', name: 'Whetstone Fetish',
    cost: { iron: 14, essence: 4 }, stats: { crit: 0.05, critDmg: 0.15 },
    desc: '+5% critical chance and +15% critical damage.' },
  { id: 'huntersEye', slot: 'head', level: 20, icon: '👁️', name: "Hunter's Eye",
    cost: { hide: 20, essence: 6 }, stats: { hp: 90, crit: 0.06 },
    worn: { color: 0x6f5a3c, trim: 0x8f7a52 },
    desc: '+90 ❤️ and +6% critical chance. You learn where things are soft.' },
  { id: 'razorVest', slot: 'underlayer', level: 22, icon: '🎽', name: 'Razorweave Vest',
    cost: { hide: 18, iron: 10, essence: 5 }, stats: { hp: 70, crit: 0.05 },
    worn: { color: 0x5c4436, trim: 0x8a6a4a },
    desc: '+70 ❤️ and +5% critical chance woven into the lining.' },
  { id: 'duelistGloves', slot: 'underlayer', level: 28, icon: '🧤', name: "Duelist's Wraps",
    cost: { hide: 22, iron: 14, essence: 9 }, stats: { crit: 0.08, critDmg: 0.20 },
    worn: { color: 0x7a2f36, trim: 0xb45a4a },
    desc: '+8% critical chance and +20% critical damage. Nothing else — pure edge.' },
  { id: 'executionersHood', slot: 'head', level: 33, icon: '🩸', name: "Executioner's Hood",
    cost: { hide: 26, iron: 16, essence: 14 }, stats: { hp: 150, critDmg: 0.35 },
    worn: { color: 0x3a2f34, trim: 0x6a4a44 },
    desc: '+150 ❤️ and +35% critical damage. It is not about how often.' },
  { id: 'sharpshotCloak', slot: 'back', level: 30, icon: '🏹', name: 'Sharpshot Cloak',
    cost: { hide: 24, essence: 12 }, stats: { hp: 120, crit: 0.05, speed: 0.8 },
    worn: { color: 0x3f5a3a, trim: 0x2a3f27 },
    desc: '+120 ❤️, +5% critical chance and a touch of speed.' },
  { id: 'perfectEdge', slot: 'charm', level: 40, icon: '💠', name: 'The Perfect Edge',
    cost: { iron: 40, essence: 30 }, stats: { crit: 0.10, critDmg: 0.30 },
    desc: '+10% critical chance and +30% critical damage. The finest charm money can buy.' },

  // ======================================================================
  // ---- LEGS / BACK / UNDERLAYER: slots that barely existed ----
  // These three slots had one, three and two items. They are also the slots
  // that now show on your body, so there is a reason to fill them.
  // ======================================================================
  { id: 'hideGreaves', slot: 'legs', level: 6, icon: '🦵', name: 'Hide Greaves',
    cost: { hide: 6, meat: 12 }, stats: { hp: 40 },
    worn: { color: 0x8a5f3a, trim: 0x5e3f26 },
    desc: '+40 max health. Better than bare shins.' },
  { id: 'furLeggings', slot: 'legs', level: 13, icon: '🧶', name: 'Fur Leggings',
    cost: { hide: 14, meat: 26 }, stats: { hp: 85, regen: 0.3 },
    worn: { color: 0x6b4a2f, trim: 0x4a3120 },
    desc: '+85 ❤️ and +0.3 ❤️/s.' },
  { id: 'ironGreaves', slot: 'legs', level: 19, icon: '🛡️', name: 'Iron Greaves',
    cost: { iron: 16, hide: 10 }, stats: { hp: 130 },
    worn: { color: 0x8d949c, trim: 0x5f666e },
    desc: '+130 max health. Heavy, and worth it.' },
  { id: 'stridersLegs', slot: 'legs', level: 26, icon: '🏃', name: "Strider's Legguards",
    cost: { hide: 22, iron: 10, essence: 8 }, stats: { hp: 110, speed: 1.6 },
    worn: { color: 0x4a5a3f, trim: 0x30402a },
    desc: '+110 ❤️ and +1.6 speed. Built for ground, not for glory.' },
  { id: 'directLegplates', slot: 'legs', level: 38, icon: '⚙️', name: 'Dread Legplates',
    cost: { iron: 34, essence: 22 }, stats: { hp: 240, regen: 0.8 },
    worn: { color: 0x40374f, trim: 0x2a2335 },
    desc: '+240 ❤️ and +0.8 ❤️/s.' },
  { id: 'woolWrap', slot: 'underlayer', level: 7, icon: '🧵', name: 'Wool Underwrap',
    cost: { wool: 8, hide: 4 }, stats: { hp: 35, regen: 0.2 },
    worn: { color: 0xbfae90, trim: 0x8c7f68 },
    desc: '+35 ❤️ and +0.2 ❤️/s. Warm, and quietly useful.' },
  { id: 'quiltedJerkin', slot: 'underlayer', level: 17, icon: '🥼', name: 'Quilted Jerkin',
    cost: { wool: 14, hide: 12, meat: 20 }, stats: { hp: 95, regen: 0.4 },
    worn: { color: 0x7c6a55, trim: 0x554738 },
    desc: '+95 ❤️ and +0.4 ❤️/s.' },
  { id: 'travellersCloak', slot: 'back', level: 9, icon: '🧣', name: "Traveller's Cloak",
    cost: { hide: 8, wool: 6 }, stats: { hp: 45, speed: 0.6 },
    worn: { color: 0x6a5a44, trim: 0x4a3e2e },
    desc: '+45 ❤️ and a little speed on the road.' },
  { id: 'rangerMantle', slot: 'back', level: 21, icon: '🌧️', name: "Ranger's Mantle",
    cost: { hide: 18, wool: 12, essence: 5 }, stats: { hp: 110, regen: 0.5 }, rest: 3,
    worn: { color: 0x40506a, trim: 0x2a374a },
    desc: '+110 ❤️, +0.5 ❤️/s and faster resting recovery.' },
  { id: 'nightcloak', slot: 'back', level: 36, icon: '🌑', name: 'Nightcloak',
    cost: { hide: 28, essence: 20 }, stats: { hp: 200, speed: 1.2 },
    worn: { color: 0x2b2536, trim: 0x191524 },
    desc: '+200 ❤️ and +1.2 speed. The dark is a garment.' },
  { id: 'oxhideBelt', slot: 'charm', level: 11, icon: '🪢', name: 'Oxhide Belt',
    cost: { hide: 12, meat: 20 }, stats: { hp: 70, regen: 0.3 },
    desc: '+70 ❤️ and +0.3 ❤️/s.' },
  { id: 'pathfinderBoots', slot: 'boots', level: 24, icon: '👟', name: 'Pathfinder Boots',
    cost: { hide: 20, essence: 7 }, stats: { speed: 3.4, hp: 60 },
    worn: { color: 0x5a6a44, trim: 0x3d4a2c },
    desc: '+3.4 speed and +60 ❤️.' },
  { id: 'ironsoleBoots', slot: 'boots', level: 31, icon: '🥾', name: 'Ironsole Boots',
    cost: { iron: 26, hide: 14, essence: 10 }, stats: { hp: 170, speed: 2.2 },
    worn: { color: 0x8d949c, trim: 0x5f666e },
    desc: '+170 ❤️ and +2.2 speed.' },

  // ======================================================================
  // ---- BOSS TRADE-OFF GEAR: a great gift with a real cost ----
  // bossOnly, so it is never for sale — a boss has to hand it to you. Every
  // piece gives something large and TAKES something real, so equipping one is
  // a decision instead of a straight upgrade.
  // ======================================================================
  { id: 'berserkersMask', slot: 'head', level: 20, bossOnly: true, icon: '😤', name: "Berserker's Mask",
    stats: { crit: 0.15, hp: -60 },
    worn: { color: 0x8a3a2a, trim: 0x5a2318 },
    desc: 'BOSS DROP — +15% critical chance, but −60 max health. Fury has a price.' },
  { id: 'glassCannonRobe', slot: 'chest', level: 24, bossOnly: true, icon: '🔮', name: 'Robe of Glass',
    stats: { hp: -120, critDmg: 0.60 },
    worn: { color: 0x6a4a86, trim: 0x452f5c },
    desc: 'BOSS DROP — +60% critical damage and −120 max health. You will hit like thunder and fold like paper.' },
  { id: 'leadHarness', slot: 'chest', level: 26, bossOnly: true, icon: '🏋️', name: 'Leaden Harness',
    stats: { hp: 420, speed: -1.8 },
    worn: { color: 0x5c5c60, trim: 0x3c3c40 },
    desc: 'BOSS DROP — +420 max health, but −1.8 speed. A walking wall.' },
  { id: 'gamblersCoin', slot: 'charm', level: 28, bossOnly: true, icon: '🪙', name: "Gambler's Coin",
    stats: { crit: 0.22, critDmg: -0.35 },
    desc: 'BOSS DROP — +22% critical chance but −35% critical damage. Often, and lightly.' },
  { id: 'headsmansSeal', slot: 'charm', level: 30, bossOnly: true, icon: '🪓', name: "Headsman's Seal",
    stats: { critDmg: 0.75, crit: -0.06 },
    desc: 'BOSS DROP — +75% critical damage but −6% critical chance. Rarely, and catastrophically.' },
  { id: 'thornedPlate', slot: 'chest', level: 34, bossOnly: true, icon: '🌵', name: 'Thorned Plate',
    stats: { hp: 300, regen: -0.6 },
    worn: { color: 0x4a5a3a, trim: 0x2f3a26 },
    desc: 'BOSS DROP — +300 max health, but the barbs bite inward: −0.6 ❤️/s.' },
  { id: 'swiftshadowBoots', slot: 'boots', level: 36, bossOnly: true, icon: '💨', name: 'Swiftshadow Boots',
    stats: { speed: 5.5, hp: -150 },
    worn: { color: 0x2b2536, trim: 0x191524 },
    desc: 'BOSS DROP — +5.5 speed and −150 max health. Outrun what you cannot survive.' },
  { id: 'martyrsMantle', slot: 'back', level: 42, bossOnly: true, icon: '🕯️', name: "Martyr's Mantle",
    stats: { regen: 3.2, hp: -200 },
    worn: { color: 0xb5a06a, trim: 0x7d6c44 },
    desc: 'BOSS DROP — +3.2 ❤️/s regeneration and −200 max health. A smaller candle that never goes out.' },
  { id: 'crownOfRuin', slot: 'head', level: 46, bossOnly: true, icon: '👑', name: 'Crown of Ruin',
    stats: { crit: 0.18, critDmg: 0.45, hp: -250, speed: -0.8 },
    worn: { color: 0xd8b24a, trim: 0x9a7f2e },
    desc: 'BOSS DROP — +18% crit chance and +45% crit damage, at −250 ❤️ and −0.8 speed. Everything, for everything.' },
];
...
export const CLASS_TREES = [
  { id: 'warrior', icon: '🛡️', name: 'Warrior', color: '#d99b62',
    ...
    passives: [
      ...
      P('war_cleave', '🪓', 'Cleave Training', 14, 'Widens your swing arc AND sharpens each blow, so it pays off even one-on-one.', { arcBonus: [0.12, 0.24, 0.38], meleeDmg: [0.02, 0.04, 0.06] }),
    ...
    actives: [
      ...
      A('war_rend', '🩸', 'Rend', 7, 'Stab one target; it loses a percentage of max HP over 30 s (capped on bosses).', 'target',
        { cd: 22, range: 3.2, weaponMult: [1.4, 2.0, 2.6], bleedPct: [0.10, 0.16, 0.25], bleedDur: 30 }),
      ...
      A('war_whirlwind', '🌪️', 'Whirlwind', 24, 'A powerful spinning melee attack that hits everything around you — and detonates your bleeds.', 'aoe',
        { cd: 16, radius: [5, 5.5, 6.5], weaponMult: [1.5, 2.0, 2.6], detonate: true }),
      A('war_cleaving_wave', '🌊', 'Cleaving Wave', 29, 'Send a broad damaging wave in front of you that detonates active bleeds.', 'cone',
        { cd: 15, range: [7, 8.5, 10], weaponMult: [1.4, 1.9, 2.4], detonate: true }),
  ...
  { id: 'beastmaster', icon: '🏹', name: 'Beastmaster', color: '#9bc56b',
    ...
    actives: [
      ...
      A('beast_explosive_arrow', '💣', 'Explosive Arrow', 24, 'Detonate a burning blast at the aimed location — pops bleeds/poison on everything it hits.', 'zoneBurst',
        { cd: 20, castRange: 20, radius: [3.5, 4.2, 5], weaponMult: [1.3, 1.8, 2.3], burn: [8, 13, 18], detonate: true }),
      ...
      A('beast_barbed_volley', '🩸', 'Barbed Volley', 40, 'Fire barbed arrows into EVERY Shift-marked enemy (bow), each tearing a deep bleed over 6 s.', 'markedVolley',
        { cd: 22, range: 24, marks: [2, 3, 4], weaponMult: [1.1, 1.5, 2.0], bleed: [0.03, 0.05, 0.08] }),
    ] },
  ...
  { id: 'rogue', icon: '🗡️', name: 'Rogue', color: '#8ec6c9',
    ...
    actives: [
      A('rogue_fleet', '🌗', 'Shadow Dance', 30, 'For a few seconds EVERY strike counts as a backstab — even from the front — and builds Combo Points twice as fast.', 'buff',
      ...
      A('rogue_shadow_portal', '🌌', 'Shadow Portal', 10, 'Tear open a portal and step through it. You vanish for a beat, travel unseen, and step out of a second portal 5/9/15 m ahead. Walls stop the far end — it is a passage, not a phase.', 'shadowBlink',
  ...
  { id: 'mage', icon: '🧙', name: 'Mage', color: '#9c9cff',
    ...
    passives: [
      ...
      P('mage_focus', '⏳', 'Arcane Focus', 14, 'Mage cooldowns -6% per rank.', { classCdReduction: 0.06 }),
      ...
      P('mage_surge', '💫', 'Elemental Surge', 37, '+6% class spell critical chance per rank.', { spellCrit: 0.06 }),
    ...
    actives: [
      ...
      A('mage_frost_nova', '🧊', 'Frost Nova', 20, 'Freeze all enemies around you and detonate their burns.', 'magicAoe',
        { cd: 24, element: 'frost', radius: [5, 6, 7], damage: [25, 42, 62], stun: [2.0, 2.5, 3.0], detonate: true }),
      ...
      A('mage_fire_breath', '🐉', 'Dragon Breath', 29, 'Scorch every enemy in a cone and detonate their DoTs.', 'magicCone',
  ...
  { id: 'priest', icon: '⛪', name: 'Priest', color: '#f0df91',
    ...
    actives: [
      ...
      A('priest_renew', '🌿', 'Renew', 7, 'Regenerate health over time.', 'hot',
        { cd: 18, duration: [8, 11, 14], amount: [7, 11, 16] }),
      ...
      A('priest_holy_nova', '☀️', 'Holy Nova', 29, 'Heal yourself while damaging nearby enemies.', 'holyNova',
        { cd: 20, radius: [5, 6.5, 8], amount: [45, 75, 110], damage: [110, 185, 260] }),
...
// ==========================================================================
// The base upgrade tree was removed — home is a fixed homestead now. The
// export stays (empty) so nothing that imports it has to be rewritten.
...
export const SMITH_GROUPS = [
  ...
  { key: 'weapons', label: '⚔️ Weapons', items: () => ITEMS.filter(i => i.slot === 'weapon' && !i.free && !i.unique && !i.bossOnly) },
  { key: 'gear',    label: '🛡️ Gear',    items: () => ITEMS.filter(i =>
      (['head', 'chest', 'boots', 'charm', 'legs', 'back', 'underlayer'].includes(i.slot) || i.shield)
      && !i.unique && !i.bossOnly && !i.supply) },
